...
void LuaUserdata<TYPE>::Bind(std::string name, RET (TYPE::*func)(ARG0, ARG1))
{
    ...
    Lua lua(state);
    auto luaFunc
        = lua.CreateFunction<RET(ARG0, ARG1)>(std::bind(func, t, std::placeholders::_1, std::placeholders::_2));
    LuaTable table = GetMetaTable();
    table.Set(name, luaFunc);
}
...
void LuaUserdata<TYPE>::Bind(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2))
{
    ...
    TYPE* t = RetrieveData();
    Lua lua(state);
    auto luaFunc = lua.CreateFunction<RET(ARG0, ARG1, ARG2)>(
        std::bind(func, t, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
    LuaTable table = GetMetaTable();
    table.Set(name, luaFunc);
}
...
void LuaUserdata<TYPE>::Bind(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3))
{
    ...
    TYPE* t = RetrieveData();
    Lua lua(state);
    auto luaFunc = lua.CreateFunction<RET(ARG0, ARG1, ARG2, ARG3)>(
        std::bind(func, t, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
    LuaTable table = GetMetaTable();
    table.Set(name, luaFunc);
}
...
void LuaUserdata<TYPE>::Bind(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4))
{
    ...
    TYPE* t = RetrieveData();
    Lua lua(state);
    auto luaFunc = lua.CreateFunction<RET(ARG0, ARG1, ARG2, ARG3, ARG4)>(std::bind(func,
                                                                                   t,
                                                                                   std::placeholders::_1,
                                                                                   std::placeholders::_2,
                                                                                   std::placeholders::_3,
...
void LuaUserdata<TYPE>::Bind(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5))
{
    ...
    TYPE* t = RetrieveData();
    Lua lua(state);
    auto luaFunc = lua.CreateFunction<RET(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5)>(std::bind(func,
                                                                                         t,
                                                                                         std::placeholders::_1,
                                                                                         std::placeholders::_2,
                                                                                         std::placeholders::_3,
...
void LuaUserdata<TYPE>::Bind(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6))
{
    ...
    TYPE* t = RetrieveData();
    Lua lua(state);
    auto luaFunc = lua.CreateFunction<RET(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)>(std::bind(func,
                                                                                               t,
                                                                                               std::placeholders::_1,
                                                                                               std::placeholders::_2,
                                                                                               std::placeholders::_3,
...
void LuaUserdata<TYPE>::Bind(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7))
{
    ...
    Lua lua(state);
    auto luaFunc
        = lua.CreateFunction<RET(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)>(std::bind(func,
                                                                                            t,
                                                                                            std::placeholders::_1,
                                                                                            std::placeholders::_2,
                                                                                            std::placeholders::_3,
...
void LuaUserdata<TYPE>::BindYield(std::string name, RET (TYPE::*func)(ARG0, ARG1))
{
    ...
    Lua lua(state);
    auto luaFunc
        = lua.CreateYieldingFunction<RET(ARG0, ARG1)>(std::bind(func, t, std::placeholders::_1, std::placeholders::_2));
    LuaTable table = GetMetaTable();
    table.Set(name, luaFunc);
}
...
void LuaUserdata<TYPE>::BindYield(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2))
{
    ...
    TYPE* t = RetrieveData();
    Lua lua(state);
    auto luaFunc = lua.CreateYieldingFunction<RET(ARG0, ARG1, ARG2)>(
        std::bind(func, t, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
    LuaTable table = GetMetaTable();
    table.Set(name, luaFunc);
}
...
void LuaUserdata<TYPE>::BindYield(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3))
{
    ...
    TYPE* t = RetrieveData();
    Lua lua(state);
    auto luaFunc = lua.CreateYieldingFunction<RET(ARG0, ARG1, ARG2, ARG3)>(
        std::bind(func, t, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
    LuaTable table = GetMetaTable();
    table.Set(name, luaFunc);
}
...
void LuaUserdata<TYPE>::BindYield(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4))
{
    ...
    TYPE* t = RetrieveData();
    Lua lua(state);
    auto luaFunc = lua.CreateYieldingFunction<RET(ARG0, ARG1, ARG2, ARG3, ARG4)>(std::bind(func,
                                                                                           t,
                                                                                           std::placeholders::_1,
                                                                                           std::placeholders::_2,
                                                                                           std::placeholders::_3,
...
void LuaUserdata<TYPE>::BindYield(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5))
{
    ...
    Lua lua(state);
    auto luaFunc
        = lua.CreateYieldingFunction<RET(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5)>(std::bind(func,
                                                                                        t,
                                                                                        std::placeholders::_1,
                                                                                        std::placeholders::_2,
                                                                                        std::placeholders::_3,
...
void LuaUserdata<TYPE>::BindYield(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6))
{
    ...
    Lua lua(state);
    auto luaFunc
        = lua.CreateYieldingFunction<RET(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)>(std::bind(func,
                                                                                              t,
                                                                                              std::placeholders::_1,
                                                                                              std::placeholders::_2,
                                                                                              std::placeholders::_3,
...
void LuaUserdata<TYPE>::BindYield(std::string name, RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7))
{
    ...
    TYPE* t = RetrieveData();
    Lua lua(state);
    auto luaFunc = lua.CreateYieldingFunction<RET(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7)>(
        std::bind(func,
                  t,
                  std::placeholders::_1,
                  std::placeholders::_2,
...
template <typename RET,
          ...
          typename ARG6,
          typename ARG7>
void LuaUserdata<TYPE>::BindYield(std::string name,
                                  RET (TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7) const)
{
    using namespace std::placeholders;
    TYPE* t = RetrieveData();
    Lua lua(state);
