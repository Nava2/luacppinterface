...
public:
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<R(T1, T2, T3, T4)>* func
            = (std::function<R(T1, T2, T3, T4)>*)lua_touserdata(state, lua_upvalueindex(1));
...
public:
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<R(T1, T2, T3, T4, T5)>* func
            = (std::function<R(T1, T2, T3, T4, T5)>*)lua_touserdata(state, lua_upvalueindex(1));
...
public:
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<R(T1, T2, T3, T4, T5, T6)>* func
            = (std::function<R(T1, T2, T3, T4, T5, T6)>*)lua_touserdata(state, lua_upvalueindex(1));
...
public:
    ...
    rettype
    Invoke(arg1type arg1, arg2type arg2, arg3type arg3, arg4type arg4, arg5type arg5, arg6type arg6, arg7type arg7)
    {
        PushToStack(state.get());
        pusher<arg1type>::push(state, arg1);
        pusher<arg2type>::push(state, arg2);
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<R(T1, T2, T3, T4, T5, T6, T7)>* func
            = (std::function<R(T1, T2, T3, T4, T5, T6, T7)>*)lua_touserdata(state, lua_upvalueindex(1));
...
public:
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<R(T1, T2, T3, T4, T5, T6, T7, T8)>* func
            = (std::function<R(T1, T2, T3, T4, T5, T6, T7, T8)>*)lua_touserdata(state, lua_upvalueindex(1));
