...
public:
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<void(T1, T2, T3)>* func
            = (std::function<void(T1, T2, T3)>*)lua_touserdata(state, lua_upvalueindex(1));
...
public:
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<void(T1, T2, T3, T4)>* func
            = (std::function<void(T1, T2, T3, T4)>*)lua_touserdata(state, lua_upvalueindex(1));
...
public:
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<void(T1, T2, T3, T4, T5)>* func
            = (std::function<void(T1, T2, T3, T4, T5)>*)lua_touserdata(state, lua_upvalueindex(1));
...
public:
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<void(T1, T2, T3, T4, T5, T6)>* func
            = (std::function<void(T1, T2, T3, T4, T5, T6)>*)lua_touserdata(state, lua_upvalueindex(1));
...
public:
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<void(T1, T2, T3, T4, T5, T6, T7)>* func
            = (std::function<void(T1, T2, T3, T4, T5, T6, T7)>*)lua_touserdata(state, lua_upvalueindex(1));
...
public:
    ...
    static int staticFunction(lua_State* state)
    {
        std::function<void(T1, T2, T3, T4, T5, T6, T7, T8)>* func
            = (std::function<void(T1, T2, T3, T4, T5, T6, T7, T8)>*)lua_touserdata(state, lua_upvalueindex(1));
